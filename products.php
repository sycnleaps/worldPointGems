...
if(isset($gem_type)) {
	$sql = "SELECT * FROM subcategory WHERE id=$gem_type AND mainCategory=$gem_category";
	$result = mysqli_query($conn, $sql);
	$gem_type_row = mysqli_fetch_array($result);
}
?>
<!doctype html>
            			...
            			<div class="col-12 col-sm-12">
            				<div class="korando-breadcrump">
								<ul>
									...
									<li><?php echo $gem_type_row['name']; ?></li>
								</ul>
            				</div>
            			</div>
            		</div>
							...
							<div class="main-content">
								<div class="shop-page-header" style="background-image:url('assets/img/banner/bg_shop.jpg'); background-repeat: no-repeat">
									<div class="col-12 col-lg-10">
										<div class="product-about-content">
											<h4><?php echo $gem_type_row['name']; ?></h4>
											<p><?php echo $gem_type_row['description']; ?></p>
										</div>
									</div>
								</div>
								<div class="shop-page-product-area">
									...
									if(isset($gem_category)) {
										$sql = "SELECT * FROM product WHERE gem_category=$gem_category AND gem_type=$gem_type";
										$result = mysqli_query($conn, $sql);
