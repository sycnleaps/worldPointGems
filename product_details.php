...
if(isset($gem_category)) {
	$sql = "SELECT * FROM product WHERE gem_category=$gem_category AND gem_type=$gem_type AND id=$gem";
						...
						<div class="col-12 col-md-6">
							<div class="single-product-description">
								<br class="product-description-content product-review">
									<h2><?php echo $gem_row["name"]; ?></h2>
									<p><?php echo $gem_row["small_description"]; ?></p>
									<div class="price-box">
									...
									<div class="product-meta product-review">
										...
										<p class="product-sku">SKU : <span> <?php echo $gem_row["sku"]; ?></span></p>
										<p class="product-sku">Origin : <?php echo $gem_row["origin"]; ?></p>
									</div>

									<div class="product-meta">
										<h6><strong>Product Details</strong></h6>
										<div class="col-6 col-md-6">
											<p>Dimensions : <?php echo $gem_row["dimensions"]; ?></p>
											<p>Color : <?php echo $gem_row["color"]; ?></p>
											<p>Shape: <?php echo $gem_row["shape"]; ?></p>
											<p>Cut : <?php echo $gem_row["cut"]; ?></p>
										</div>
										<div class="col-6 col-md-6">
