						...
						<div class="row">
							<div class="col-12 col-lg-7">
								<div class="about-content">
									<h3>World Point Gems</h3>
									<p>World Point Gems is a Global Supplier of responsibly sourced loose gemstones, and colored gem studded jewelry. We strive to provide a unique quality experience online that though exists in other ecommerce segments, is often found to be elusive in the gems and jewelry segment.</p>
									<p>World Point Gems specializes in the Mining & Marketing of Natural Colored Gems Stones, both Precious stones and Semi-precious stones. We are a young, dynamic company and support raw emerging talent wherever possible, working with cutting-edge designers as well as some of the most iconic brands.</p>

								</div>
							</div>
							<div class="col-12 col-lg-5">
								<div class="about-image">
									<img src="assets/img/home/about.jpg" style="width: 73%" alt="about image">
								</div>
							</div>
						</div>
					</div>
